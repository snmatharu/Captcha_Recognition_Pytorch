...
def run_training():
    ...
    targets_orig = [x.split("/")[-1][:-4] for x in image_files] #splitting the label as ['a', 'b', 'c'] by not including .png 
    ...
    targets_enc = np.array(targets_enc) + 1     #we are adding 1 as we will keep 0 for the unknown nos 
    ...
    #above we are dividing the data into train and test mode
